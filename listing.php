<?php
 include 'preLoad.php'  ?>
<?php $populationSize = "1000000";  ?>
<?php
$sqlTOP10Skills="
SELECT DISTINCT
    (skills.skillCategory) AS QskillCategory
FROM
    companies, skills
WHERE
    1 = 1 AND city =  '".$URLCity."'
...
<!doctype html>
  <html lang="en">
<head>
<title>Where to fing the best<?php print $URLSkill ?> jobs in <?php print $URLCity ?></title>
      ...
      <div class="usa-banner">
        <div class="usa-accordion">
          <header class="usa-banner-header">
            ...
            <p>Created by <a href="http://paulsizemore.com">Paul Sizemore</a></p>
          ...
          <nav class="usa-footer-nav">
            <ul class="usa-unstyled-list">
              <li class="usa-width-one-fourth usa-footer-primary-content">
                <a class="usa-footer-primary-link" href="http://lovedjos.com/">Home</a>
              </li>
              <li class="usa-width-one-fourth usa-footer-primary-content">
                <a class="usa-footer-primary-link" href="http://lovedjos.com/wp/">Blog</a>
              </li>
            </ul>
          </nav>
        </div>
