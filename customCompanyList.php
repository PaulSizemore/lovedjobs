...
where 1=1  ".$citySqlTest ."  ".$argJob."   ORDER BY postingCount DESC LIMIT 1000";
...
{    
echo  "<li class=\"detailBox\"><a target=\"_blank\" href=\"https://www.google.com/search?q=".$row[companyName]."&chnl=loveLang&userip=".$_SERVER['REMOTE_ADDR']."&useragent=".$_SERVER['HTTP_USER_AGENT']."\" >".substr($row[companyName],'0','50')."<div class=\"detailCompany\">".substr($row[company],'0','30')." ".$row[postingCount]." <img style=\"padding-left:10px\" src=\"assets\\web.png\" width=\"12\" heigth=\"12\">
<div style='padding-top:5px;' ></div></li>"   ;
}
print "</ul>"; 
}		
